...
import com.example.success.asingpay.API.ApiService;
import com.example.success.asingpay.Adapter.ListArrayAdapter;
...
public class DaftarPenghuniActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listview.setOnItemClickListener(DaftarPenghuniActivity.this);
                ...
                if (response.isSuccessful()) {
                    ...
                    for (int i = 0; i < jumlah; i++) {
                        ...
                        ModelData data = new ModelData(
                                ...
                                response.body().get(i).getNm_orangtua(),
                                response.body().get(i).getNo_hp(),
                                response.body().get(i).getThn_masuk(),
                                response.body().get(i).getStats_masuk(),
                                response.body().get(i).getNm_kampus(),
                                response.body().get(i).getPhoto());
                    ...
                    adapter = new ListArrayAdapter(DaftarPenghuniActivity.this, R.layout.row_mahasiswa, datamahasiswa);
